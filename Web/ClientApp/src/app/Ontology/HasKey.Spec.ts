...
describe(
    ...
    () =>
    {
        ...
        describe(
            'Given an Ontology o1 with declarations Class(c1), NamedIndividual(i1), DataProperty(dp1) and DataPropertyAssertion(dp1, i1, 1): ',
            () =>
            {
                let o1 = new Ontology('o1');
                let i1 = new NamedIndividual(o1, 'i1');
                ...
                describe(
                    'Given additional declaration HasKey(DataMinCardinality(dp1, 1), [ dp1 ]): ',
                    () =>
                    {
