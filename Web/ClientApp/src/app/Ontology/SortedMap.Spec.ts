...
describe(
    ...
    {
        describe(
            "Given entries: [any[], any][] = [[[], 'A'], [[0], 'B'], [[0, 1], 'C'], [[0, 2], 'D']] and map = new SortedMap(ArrayCompareFactory(), entries):",
            () =>
            {
        ...
        describe(
            "Given map = new SortedMap(ArrayCompareFactory()) and map.set([0, 1], 'A'):",
            () =>
            {
                const map = new SortedMap(ArrayCompareFactory());
                map.set(
                    [0, 1],
                    'A');
        ...
        describe(
            "Given map = new SortedMap(ArrayCompareFactory(), [[[0, 1], 'A']]) and map.set([0, 1], 'B'):",
            () =>
            {
                const map = new SortedMap(ArrayCompareFactory(), [[[0, 1], 'A']]);
                map.set(
                    [0, 1],
                    'B');
                let assert = assertBuilder('map')(map);
        ...
        describe(
            "Given map = new SortedMap(ArrayCompareFactory(), [[[0, 1], 'A']]) and map.delete([0, 1]):",
            () =>
            {
                const map = new SortedMap(ArrayCompareFactory(), [[[0, 1], 'A']]);
                map.delete([0, 1]);
